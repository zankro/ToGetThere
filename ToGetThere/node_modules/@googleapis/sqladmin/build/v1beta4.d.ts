...
export declare namespace sqladmin_v1beta4 {
    ...
    export class Resource$Backups {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        createBackup(params: Params$Resource$Backups$Createbackup, options: StreamMethodOptions): GaxiosPromise<Readable>;
        createBackup(params?: Params$Resource$Backups$Createbackup, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        deleteBackup(params: Params$Resource$Backups$Deletebackup, options: StreamMethodOptions): GaxiosPromise<Readable>;
        deleteBackup(params?: Params$Resource$Backups$Deletebackup, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getBackup(params: Params$Resource$Backups$Getbackup, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getBackup(params?: Params$Resource$Backups$Getbackup, options?: MethodOptions): GaxiosPromise<Schema$Backup>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        listBackups(params: Params$Resource$Backups$Listbackups, options: StreamMethodOptions): GaxiosPromise<Readable>;
        listBackups(params?: Params$Resource$Backups$Listbackups, options?: MethodOptions): GaxiosPromise<Schema$ListBackupsResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateBackup(params: Params$Resource$Backups$Updatebackup, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateBackup(params?: Params$Resource$Backups$Updatebackup, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
    ...
    export class Resource$Instances {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        pointInTimeRestore(params: Params$Resource$Instances$Pointintimerestore, options: StreamMethodOptions): GaxiosPromise<Readable>;
        pointInTimeRestore(params?: Params$Resource$Instances$Pointintimerestore, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
